        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="register.jsp">Đăng ký</a></li>
                </ul>
            </div>
        </div>
    </nav>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="${pageContext.request.contextPath}/register" method="post" class="needs-validation" novalidate>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="username" name="username" value="${username}" required minlength="3" autofocus>
                                <div class="invalid-feedback">Tên đăng nhập phải có ít nhất 3 ký tự</div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="password" class="form-label">Mật khẩu (≥ 6 ký tự)</label>
                        ...
                        <p class="text-center mt-3 mb-0">Đã có tài khoản? <a href="login.jsp">Đăng nhập</a></p>
                    </div>
                </div>
            </div>
        </div>
