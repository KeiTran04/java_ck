...
<head>
    ...
    <title>Quên mật khẩu - Shop</title>
            ...
            <div class="col-md-5 col-lg-4">
                <div class="card shadow-sm">
                    <div class="card-body p-4">
                        <h2 class="text-center mb-4"><i class="bi bi-key"></i> Quên mật khẩu</h2>
                        ...
                        <c:if test="${not empty info}">
                            <div class="alert alert-info alert-dismissible auto-dismiss fade show">${info}<button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>
                        </c:if>
